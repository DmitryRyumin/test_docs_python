...
with open('README.md', 'r') as fh:
    ...
    setup(
        ...
        project_urls = {
            'Bug Reports': 'https://github.com/DmitryRyumin/test_docs_python/issues',
            'Documentation': 'https://test-docs-python.readthedocs.io',
            'Source Code': 'https://github.com/DmitryRyumin/test_docs_python/tree/main/test_docs_python',
            'Download': 'https://github.com/DmitryRyumin/test_docs_python/tags',
        },
    )
