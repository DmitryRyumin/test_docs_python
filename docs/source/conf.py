...
project = test_docs_python.__title__

# Автор(ы) проекта
author = test_docs_python.__author__en__

# Авторские права
copyright = test_docs_python.__copyright__

# Версия проекта
version = test_docs_python.__version__
release = test_docs_python.__release__
...
latex_documents = [
  ('index', 'PDF.tex', u'PDF', u'TestDocsPython', 'manual'),
]
